...
public class TestWeatherStation {
	...
	public void testWeatherStation3() { 
		...
		//Temp drops
		ws.set_measurements(10.0, 10.0);
		ws.publish();
		
		//Calculations from 3 readings
		assertEquals(10.0, obs1.getMinTemperature(),0.01);
		assertEquals(23.2, obs1.getMaxTemperature(), 0.01);
		assertEquals(17.0, obs1.getAverageTemperature(), 0.01);
		
		//Temp increases
		ws.set_measurements(1000.0, 10.0);
		ws.publish();
		
		//Calculations from 4 readings
		assertEquals(10.0, obs1.getMinTemperature(), 0.01);
		assertEquals(1000.0, obs1.getMaxTemperature(), 0.01);
		assertEquals(262.75, obs1.getAverageTemperature(), 0.01);
	}
	...
	public void testWeatherStation4() { 
		...
		//Pressure increases
		ws.set_measurements(10.0, 1100.0);
		ws.publish();
		
		assertEquals(1100.0, obs2.getCurrentPressure(), 0.01);
		assertEquals(1015.3, obs2.getLastPressure(), 0.01);
		assertFalse(obs2.isLikelyToRain());
		
		//Pressure decreases
		ws.set_measurements(10, 1.0);
		ws.publish();
		
		assertEquals(1.0, obs2.getCurrentPressure(), 0.01);
		assertEquals(1100.0, obs2.getLastPressure(), 0.01);
		assertTrue(obs2.isLikelyToRain());
	}
}
